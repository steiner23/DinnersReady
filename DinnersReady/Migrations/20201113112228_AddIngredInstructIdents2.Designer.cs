...
namespace DinnersReady.Migrations
{
    ...
    [Migration("20201113112228_AddIngredInstructIdents2")]
    partial class AddIngredInstructIdents2
    {
            ...
            modelBuilder.Entity("DinnersReadyCore.Models.RecipeIngredients.RecipeIngredient", b =>
                {
                    ...
                    b.Property<string>("RecipeIngredientIdent")
                        .IsRequired()
                        .HasColumnType("nvarchar(16)")
                        .HasMaxLength(16);
            ...
            modelBuilder.Entity("DinnersReadyCore.Models.RecipeInstructions.RecipeInstruction", b =>
                {
                    ...
                    b.Property<string>("RecipeInstructionIdent")
                        .IsRequired()
                        .HasColumnType("nvarchar(16)")
                        .HasMaxLength(16);
